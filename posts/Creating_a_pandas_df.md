...
####  Read from csv
A csv (or comma separated value) file that contains our temperature example can be [downloaded here.](https://joehowie.ca/example_scripts/temperature_data.csv) With the data downloaded, you can now load it into a pandas DataFrame running the following python code.
```python
import pandas as pd
